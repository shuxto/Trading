...
export const ASSETS: Asset[] = [
  // ==========================================
  // 🚀 CRYPTO (Source: BINANCE) - TOP 40
  // ==========================================
  { symbol: 'BTCUSDT', displaySymbol: 'BTC/USD', name: 'Bitcoin', type: 'crypto', price: 0, change: 0, source: 'binance', logo: 'https://assets.coincap.io/assets/icons/btc@2x.png' },
  { symbol: 'ETHUSDT', displaySymbol: 'ETH/USD', name: 'Ethereum', type: 'crypto', price: 0, change: 0, source: 'binance', logo: 'https://assets.coincap.io/assets/icons/eth@2x.png' },
  { symbol: 'SOLUSDT', displaySymbol: 'SOL/USD', name: 'Solana', type: 'crypto', price: 0, change: 0, source: 'binance', logo: 'https://assets.coincap.io/assets/icons/sol@2x.png' },
  { symbol: 'BNBUSDT', displaySymbol: 'BNB/USD', name: 'Binance Coin', type: 'crypto', price: 0, change: 0, source: 'binance', logo: 'https://assets.coincap.io/assets/icons/bnb@2x.png' },
  { symbol: 'XRPUSDT', displaySymbol: 'XRP/USD', name: 'Ripple', type: 'crypto', price: 0, change: 0, source: 'binance', logo: 'https://assets.coincap.io/assets/icons/xrp@2x.png' },
  { symbol: 'ADAUSDT', displaySymbol: 'ADA/USD', name: 'Cardano', type: 'crypto', price: 0, change: 0, source: 'binance', logo: 'https://assets.coincap.io/assets/icons/ada@2x.png' },
  { symbol: 'DOGEUSDT', displaySymbol: 'DOGE/USD', name: 'Dogecoin', type: 'crypto', price: 0, change: 0, source: 'binance', logo: 'https://assets.coincap.io/assets/icons/doge@2x.png' },
  { symbol: 'AVAXUSDT', displaySymbol: 'AVAX/USD', name: 'Avalanche', type: 'crypto', price: 0, change: 0, source: 'binance', logo: 'https://assets.coincap.io/assets/icons/avax@2x.png' },
  { symbol: 'DOTUSDT', displaySymbol: 'DOT/USD', name: 'Polkadot', type: 'crypto', price: 0, change: 0, source: 'binance', logo: 'https://assets.coincap.io/assets/icons/dot@2x.png' },
  { symbol: 'LINKUSDT', displaySymbol: 'LINK/USD', name: 'Chainlink', type: 'crypto', price: 0, change: 0, source: 'binance', logo: 'https://assets.coincap.io/assets/icons/link@2x.png' },
  { symbol: 'MATICUSDT', displaySymbol: 'MATIC/USD', name: 'Polygon', type: 'crypto', price: 0, change: 0, source: 'binance', logo: 'https://assets.coincap.io/assets/icons/matic@2x.png' },
  { symbol: 'LTCUSDT', displaySymbol: 'LTC/USD', name: 'Litecoin', type: 'crypto', price: 0, change: 0, source: 'binance', logo: 'https://assets.coincap.io/assets/icons/ltc@2x.png' },
  { symbol: 'UNIUSDT', displaySymbol: 'UNI/USD', name: 'Uniswap', type: 'crypto', price: 0, change: 0, source: 'binance', logo: 'https://assets.coincap.io/assets/icons/uni@2x.png' },
  { symbol: 'TRXUSDT', displaySymbol: 'TRX/USD', name: 'TRON', type: 'crypto', price: 0, change: 0, source: 'binance', logo: 'https://assets.coincap.io/assets/icons/trx@2x.png' },
  { symbol: 'SHIBUSDT', displaySymbol: 'SHIB/USD', name: 'Shiba Inu', type: 'crypto', price: 0, change: 0, source: 'binance', logo: 'https://assets.coincap.io/assets/icons/shib@2x.png' },
  { symbol: 'ETCUSDT', displaySymbol: 'ETC/USD', name: 'Ethereum Classic', type: 'crypto', price: 0, change: 0, source: 'binance', logo: 'https://assets.coincap.io/assets/icons/etc@2x.png' },
  { symbol: 'NEARUSDT', displaySymbol: 'NEAR/USD', name: 'Near Protocol', type: 'crypto', price: 0, change: 0, source: 'binance', logo: 'https://assets.coincap.io/assets/icons/near@2x.png' },
  { symbol: 'ATOMUSDT', displaySymbol: 'ATOM/USD', name: 'Cosmos', type: 'crypto', price: 0, change: 0, source: 'binance', logo: 'https://assets.coincap.io/assets/icons/atom@2x.png' },
  { symbol: 'XLMUSDT', displaySymbol: 'XLM/USD', name: 'Stellar', type: 'crypto', price: 0, change: 0, source: 'binance', logo: 'https://assets.coincap.io/assets/icons/xlm@2x.png' },
  { symbol: 'BCHUSDT', displaySymbol: 'BCH/USD', name: 'Bitcoin Cash', type: 'crypto', price: 0, change: 0, source: 'binance', logo: 'https://assets.coincap.io/assets/icons/bch@2x.png' },
  { symbol: 'ALGOUSDT', displaySymbol: 'ALGO/USD', name: 'Algorand', type: 'crypto', price: 0, change: 0, source: 'binance', logo: 'https://assets.coincap.io/assets/icons/algo@2x.png' },
  { symbol: 'FILUSDT', displaySymbol: 'FIL/USD', name: 'Filecoin', type: 'crypto', price: 0, change: 0, source: 'binance', logo: 'https://assets.coincap.io/assets/icons/fil@2x.png' },
  { symbol: 'VETUSDT', displaySymbol: 'VET/USD', name: 'VeChain', type: 'crypto', price: 0, change: 0, source: 'binance', logo: 'https://assets.coincap.io/assets/icons/vet@2x.png' },
  { symbol: 'ICPUSDT', displaySymbol: 'ICP/USD', name: 'Internet Computer', type: 'crypto', price: 0, change: 0, source: 'binance', logo: 'https://assets.coincap.io/assets/icons/icp@2x.png' },
  { symbol: 'GRTUSDT', displaySymbol: 'GRT/USD', name: 'The Graph', type: 'crypto', price: 0, change: 0, source: 'binance', logo: 'https://assets.coincap.io/assets/icons/grt@2x.png' },
  { symbol: 'AAVEUSDT', displaySymbol: 'AAVE/USD', name: 'Aave', type: 'crypto', price: 0, change: 0, source: 'binance', logo: 'https://assets.coincap.io/assets/icons/aave@2x.png' },
  { symbol: 'SANDUSDT', displaySymbol: 'SAND/USD', name: 'The Sandbox', type: 'crypto', price: 0, change: 0, source: 'binance', logo: 'https://assets.coincap.io/assets/icons/sand@2x.png' },
  { symbol: 'MANAUSDT', displaySymbol: 'MANA/USD', name: 'Decentraland', type: 'crypto', price: 0, change: 0, source: 'binance', logo: 'https://assets.coincap.io/assets/icons/mana@2x.png' },
  { symbol: 'AXSUSDT', displaySymbol: 'AXS/USD', name: 'Axie Infinity', type: 'crypto', price: 0, change: 0, source: 'binance', logo: 'https://assets.coincap.io/assets/icons/axs@2x.png' },
  { symbol: 'EOSUSDT', displaySymbol: 'EOS/USD', name: 'EOS', type: 'crypto', price: 0, change: 0, source: 'binance', logo: 'https://assets.coincap.io/assets/icons/eos@2x.png' },
  { symbol: 'THETAUSDT', displaySymbol: 'THETA/USD', name: 'Theta Network', type: 'crypto', price: 0, change: 0, source: 'binance', logo: 'https://assets.coincap.io/assets/icons/theta@2x.png' },
  { symbol: 'RUNEUSDT', displaySymbol: 'RUNE/USD', name: 'THORChain', type: 'crypto', price: 0, change: 0, source: 'binance', logo: 'https://assets.coincap.io/assets/icons/rune@2x.png' },
  { symbol: 'KSMUSDT', displaySymbol: 'KSM/USD', name: 'Kusama', type: 'crypto', price: 0, change: 0, source: 'binance', logo: 'https://assets.coincap.io/assets/icons/ksm@2x.png' },
  { symbol: 'EGLDUSDT', displaySymbol: 'EGLD/USD', name: 'Elrond', type: 'crypto', price: 0, change: 0, source: 'binance', logo: 'https://assets.coincap.io/assets/icons/egld@2x.png' },
  { symbol: 'XTZUSDT', displaySymbol: 'XTZ/USD', name: 'Tezos', type: 'crypto', price: 0, change: 0, source: 'binance', logo: 'https://assets.coincap.io/assets/icons/xtz@2x.png' },
